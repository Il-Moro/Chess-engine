...
public class RockTest {
    ...
    void openBoardRock() {
        ...
        Rook rock1 = new Rook(new Position(0,0), Colour.WHITE);
        Rook rock2 = new Rook(new Position(4,3), Colour.WHITE);
        Rook rock3 = new Rook(new Position(6,5), Colour.WHITE);
    ...
    void blockByAdversaryPiece() {
        ...
        Rook blackRock = new Rook(new Position(1,2),Colour.BLACK);
        Rook whiteRock = new Rook(new Position(6,2),Colour.WHITE);
    ...
    void blockByOwnPiece(){
        ...
        Rook whiteRock1 = new Rook(new Position(1,2),Colour.WHITE);
        Rook whiteRock = new Rook(new Position(6,2),Colour.WHITE);
    ...
    void surroundedByAdversarialPieces(){
        ...
        Rook whiteRock = new Rook(new Position(2,3),Colour.WHITE);
        board.setPiece(whiteRock);
